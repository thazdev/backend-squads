...
exports.Transaction = exports.isArangoTransaction = exports.coerceTransactionCollections = void 0;
/**
 * ```ts
 ...
 * @internal
 */
function coerceTransactionCollections(options) {
...
exports.coerceTransactionCollections = coerceTransactionCollections;
//#endregion
...
class Transaction {
    ...
    async exists() {
        try {
            ...
            if (errors.isArangoError(err) && err.errorNum === codes_js_1.TRANSACTION_NOT_FOUND) {
                return false;
            }
            throw err;
        }
