...
exports.Graph = exports.isArangoGraph = exports.GraphEdgeCollection = exports.GraphVertexCollection = void 0;
/**
 * ```ts
 * import type {
 *   Graph,
...
class GraphVertexCollection {
    ...
    save(data, options) {
        return this._db.request({
            method: "POST",
            pathname: `/_api/gharial/${encodeURIComponent(this.graph.name)}/vertex/${encodeURIComponent(this._name)}`,
            body: data,
            search: options,
...
class Graph {
    ...
    async exists() {
        try {
            ...
            if (errors.isArangoError(err) && err.errorNum === codes_js_1.GRAPH_NOT_FOUND) {
                return false;
            }
            throw err;
        }
     ...
     */
    get() {
        return this._db.request({ pathname: `/_api/gharial/${encodeURIComponent(this._name)}` }, (res) => res.parsedBody.graph);
    }
    /**
    ...
    vertexCollection(collection) {
        return new GraphVertexCollection(this._db, collections.collectionToString(collection), this);
    }
    /**
    ...
    listVertexCollections() {
        return this._db.request({ pathname: `/_api/gharial/${encodeURIComponent(this._name)}/vertex` }, (res) => res.parsedBody.collections);
    }
    /**
     * Fetches all vertex collections of this graph from the database and returns
    ...
    removeVertexCollection(collection, dropCollection = false) {
        return this._db.request({
            method: "DELETE",
            pathname: `/_api/gharial/${encodeURIComponent(this._name)}/vertex/${encodeURIComponent(collections.collectionToString(collection))}`,
            search: {
                dropCollection,
            },
        }, (res) => res.parsedBody.graph);
    ...
    edgeCollection(collection) {
        return new GraphEdgeCollection(this._db, collections.collectionToString(collection), this);
    }
    /**
     ...
     */
    listEdgeCollections() {
        return this._db.request({ pathname: `/_api/gharial/${encodeURIComponent(this._name)}/edge` }, (res) => res.parsedBody.collections);
    }
    /**
     * Fetches all edge collections of this graph from the database and returns
    ...
    replaceEdgeDefinition(collectionOrEdgeDefinitionOptions, edgeDefinitionOrOptions, options = {}) {
        ...
        return this._db.request({
            method: "PUT",
            pathname: `/_api/gharial/${encodeURIComponent(this._name)}/edge/${encodeURIComponent(collections.collectionToString(collection))}`,
            body: {
                ...coerceEdgeDefinition(edgeDefinition),
                options: {
                    ...opts,
